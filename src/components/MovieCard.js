...
export default function MovieCard({movie, isWatchlisted,toggle}) {

    const handleerror=(e)=>{
        e.target.erc="images/default.jspaneg";
    }
        ...
        <div key={movie.id} className='movie-card'>
            ...
            <div className='movie-card-info'>
                ...
                <label className="switch">
                    <input type="checkbox" checked={isWatchlisted} onChange={()=>toggle(movie.id)}>
                    </input>
